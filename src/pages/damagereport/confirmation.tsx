...
const confirmationPage: NextPage<pageProps> = ({ data, images, id }) => {
  ...
  if (data !== null) {
      ...
      <div className="flex flex-col">
          ...
          {images && (
            <div>
              <div className="flex flex-row">
                <img src={images["FRONT"]} alt="FrontImage" className="w-1/2" />
                <img src={images["RIGHT"]} alt="RightImage" className="w-1/2" />
              </div>
              <div className="flex flex-row">
                <img src={images["BACK"]} alt="BackImage" className="w-1/2" />
                <img src={images["LEFT"]} alt="LeftImage" className="w-1/2" />
              </div>
            </div>
          )}
        </div>
        ...
        <div className="w-full flex flex-row justify-between">
          ...
          <button
            ...
            className="w-20 h-14 bg-MainGreen-300 rounded-full text-white mr-10 "
          >
            Complete
          </button>
        </div>
    ...
    return <div>Something went wrong with fetching data from server</div>;
  }
};
