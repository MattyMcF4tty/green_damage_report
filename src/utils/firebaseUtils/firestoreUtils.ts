  ...
  try {
    ...
    switch (error.code) {
      ...
      case "deadline-exceeded":
        newError.name = "DEADLINE_EXCEEDED";
        newError.message =
          "Fetching documents took too long to complete. Please try again.";
        break;

      case "internal":
        newError.name = "INTERNAL_ERROR";
        newError.message =
          "An internal error occurred in Firestore while fetching documents. Please try again.";
        break;

      case "permission-denied":
        newError.name = "PERMISSION_DENIED";
        newError.message =
          "You do not have the required permissions to fetch these documents.";
        break;
      ...
      default:
        ...
        newError.message =
          error.message ||
          "An unknown error occurred while fetching documents. Please try again.";
        break;
    }
