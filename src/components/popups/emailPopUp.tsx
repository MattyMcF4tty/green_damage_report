  ...
  return (
    <div className="fixed flex justify-center items-center z-20 inset-0 bg-black bg-opacity-75 overflow-auto">
      <div className="bg-white w-[20rem] p-4 rounded-md">
        <p>
          I looks like you already have ongoing reports, would you like to
        ...
        <div className="flex flex-col">
          {reportIDs.map((id, index) => (
            <button
              ...
              className="italic underline text-left"
            >
              {id}
            </button>
          ))}
        ...
        <div className="flex flex-row h-[2.4rem] mt-10 justify-evenly">
          <button
            ...
            className="bg-gray-200 p-1 h-full w-24 rounded-sm"
          >
            Cancel
          </button>
          <button
            ...
            className="bg-MainGreen-300 p-1 h-full w-24 text-white rounded-sm"
          >
            New report
          </button>
        </div>
